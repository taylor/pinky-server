...
ready: deps ngx_openresty/nginx/sbin/nginx $(HOME)/.luarocks/bin/moonc $(HOME)/.luarocks/bin/pinky copy_rocks
	@./build
	@luarocks make --local
...
$(HOME)/.luarocks/bin/moonc:
	@luarocks build --tree $(ACCEL_HOME) vendor/projects/moonscript-0.2.3-2.rockspec
